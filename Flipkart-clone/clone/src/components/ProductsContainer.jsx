        ...
        <div className="w-full flex items-center justify-start lg:justify-center gap-8 py-6">
          <motion.div whileTap={{ scale: 0.75 }}>
            ...
            >
              <img
                src={Grocery}
                className="w-15 h-2 flex flex-1 flex-row"
                alt="grocery"
              />
          ...
          <div className="relative z-10">
            ...
            >
              <img
                ...
                className="w-15 h-2 flex flex-1 flex-row"
                alt="clothes"
                onClick={() => toggleClothesOption(true)}
              />
              <div
                className="flex  items-center gap-1"
                onClick={() => toggleClothesOption(true)}
              >
                <p className=" font-semibold Weight 800 text-slate-950">
                  Fashion
                </p>
                <FontAwesomeIcon
                  icon={faCaretDown}
                ...
                <div className="absolute top-full left-1 mt-3 bg-white p-2 rounded-lg border-solid border-2 border-gray-400 z-20">
                  <div className="flex">
                    <p
                      ...
                      onMouseEnter={() => toggleMenOption(true)}
                      onMouseLeave={() => toggleMenOption(false)}
                    >
                      Men
                    </p>
                    <FontAwesomeIcon
                      icon={faCaretRight}
                      className="my-1 text-gray-400 cursor-pointer"
                      onClick={() => toggleMenOption(true)}
                    />
                  </div>
                  <div className="flex">
                    <p
                      className="cursor-pointer mr-2 relative"
                      onMouseEnter={() => toggleWomenOption(true)}
                      onMouseLeave={() => toggleWomenOption(false)}
                    >
                      Women
                    </p>
                    <FontAwesomeIcon
                      icon={faCaretRight}
                      className="my-1 text-gray-400 cursor-pointer"
                      onClick={() => toggleWomenOption(true)}
                    />
                  </div>
                  <div className="flex">
                    <p
